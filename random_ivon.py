...
from helper_functions import load_datasets, train_model_ivon, label_iteration_random
import ivon
...
np.savez(f'data/random_ivon/random_ivon_{seed}_{test_samples_ivon}.npz', datapoints=datapoint_list_ivon, accuracies=accuracy_list_ivon)